...
def launch_setup(context, *args, **kwargs):
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                [
                    PathJoinSubstitution(
                        [
                            FindPackageShare("cinteo_bringup"),
                            "launch",
                            "cinteo_base.launch.py",
                        ]
                    )
                ]
            ),
    ...
    teleop_configuration_file_path = (
        get_package_share_directory("cinteo_description") + "/config/teleop.yaml"
    )
            ...
            actions=[
                ...
                IncludeLaunchDescription(
                    PythonLaunchDescriptionSource(
                        ...
                        + "/launch/cinteo_teleop.launch.py"
                    ),
                    launch_arguments={
...
def generate_launch_description():
    ...
    robot_urdf_description = Command(
        [
            ExecutableInPackage("urdf_description.py", "cinteo_bringup"),
