...
def launch_setup(context, *args, **kwargs):
    ...
    controller_manager_configuration_file_path = (
        f'{get_package_share_directory("cinteo_bringup")}/config/controller_manager.yaml'
    )

    base_controller_configuration_file_path = (
        f'{get_package_share_directory("cinteo_bringup")}/config/mobile_base_controller.yaml'
    )
