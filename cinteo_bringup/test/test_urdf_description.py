...
def urdf_xml(mode):
    ...
    exe = (
        get_package_prefix("cinteo_bringup") + "/lib/cinteo_bringup/generate_urdf_description.py"
    )
...
def ros2_control_xml(mode):
    ...
    exe = (
        get_package_prefix("cinteo_bringup")
        + "/lib/cinteo_bringup/generate_ros2_control_description.py"
    )
...
def test_controller_filename_name():
    assert (
        ...
        == get_package_share_directory("cinteo_bringup") + "/config/controller_manager.yaml"
    )
